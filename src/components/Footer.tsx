...
export default function Footer() {
  return (
    <footer className="bg-white">
      {/* Service categories */}
      <div className="container mx-auto py-8 border-t border-b">
        <div className="flex flex-wrap justify-between">
          ...
          <div className="flex items-center px-4 py-2">
            ...
            <span className="font-bold">SITTING</span>
          </div>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="md:col-span-1 flex flex-col items-center">
              <div className="mb-4">
                <Link href="/" className="text-2xl font-bold flex items-center">
                  <span className="text-blue-400">BUBBLES</span>
                  <span className="text-white mx-1">&</span>
                  <span className="text-pink-400">BOWS</span>
                </Link>
              </div>
              ...
              <div className="flex space-x-4">
                <Link href="#" className="bg-gray-800 h-8 w-8 rounded flex items-center justify-center hover:bg-gray-700">
            ...
            <div>
              ...
              <div className="text-gray-400">
                <p className="mb-2">+202-555-0157</p>
                <p>info@bubblesandbows.com</p>
              </div>
            </div>
          </div>
          
          <div className="mt-12 pt-8 border-t border-gray-800 text-center text-gray-400 text-sm">
            <p>All Rights Reserved by Bubbles & Bows 2023</p>
          </div>
        </div>
      </div>
    </footer>
