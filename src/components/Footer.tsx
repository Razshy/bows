          ...
          <div className="flex flex-col md:flex-row justify-between items-start gap-12">
            ...
            <div className="md:w-1/3">
              ...
              <div className="flex space-x-3">
                <Link href="#" className="bg-[#6bcbeb]/10 h-10 w-10 rounded-full flex items-center justify-center hover:bg-[#6bcbeb]/20 transition-colors">
            ...
            <div className="md:w-1/4">
              ...
              <div className="space-y-3 text-gray-600">
                <p className="flex items-start">
                  ...
                  <span>123 Pet Avenue, Dogtown, CA 90210</span>
                </p>
                <p className="flex items-start">
                  <svg className="h-5 w-5 mr-2 text-[#6bcbeb] mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <p className="flex items-start">
                  ...
                  <span>info@bubblesandbows.com</span>
                </p>
              </div>
            </div>
          </div>
